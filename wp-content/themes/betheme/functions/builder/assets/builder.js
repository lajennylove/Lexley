...
(function($) {
  ...
  var MfnBuilder = (function($) {
    ...
    var preview = {
      ...
      button: function(){
        setTimeout(function() {
  				$('#editor').find('.edit-post-header .edit-post-header__settings').prepend( '<button type="button" class="components-button is-tertiary mfn-preview">Muffin Builder Preview</button>' );
  			}, 1000);
      },
      ...
      classicButton: function(){
  			$('#preview-action').append( '<a style="margin-top:5px" class="mfn-preview button" href="#">Muffin Builder Preview</a>' );
      },
