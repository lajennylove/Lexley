...
if (! function_exists('sc_table_of_contents')) {
 	function sc_table_of_contents($attr, $content = null)
 	{
 		...
 		//$output .= $mfn_headings[0][1];
 		//$output .= $mfn_headings[2];
 		...
 		// output -----
 			...
 			// This variable has been safely escaped above in this function
 			$output = '';
 			$output .= '<div class="table_of_content" data-tags="'.$tags_anchors.'" data-page="'. $id .'">';
 						...
 						foreach($mfn_headings as $key => $value){
 							...
 							switch(true){
 								case $previous_heading_level === 0: //init
 									$output .= '<li '.$custom_icon.' data-depth="'.$nested_depth.'" > <a class="scroll" href="#toc_'.$key.'"> '.sanitize_text_field($value).' </a> </li>';
