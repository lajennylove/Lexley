...
class Newsletter_Anon_Tokens {
	...
	public function __construct() {
		...
		//*************************************************************//
		add_filter( 'automator_maybe_trigger_newsletter_newsletterlist_tokens', [
			$this,
			'newsletter_possible_tokens'
		], 20, 2 );
		add_filter( 'automator_maybe_parse_token', [ $this, 'newletter_token' ], 20, 6 );
	}
	 ...
	 * @return array
	 */
	function newsletter_possible_tokens( $tokens = [], $args = [] ) {
