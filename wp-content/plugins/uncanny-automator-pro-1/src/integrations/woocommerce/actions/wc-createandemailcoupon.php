		...
		$options_array   = array(
			'options_group' => array(
				$this->action_meta => array(
					...
					$uncanny_automator->helpers->recipe->field->text_field(
						'EMAILBODY',
						__( 'Email body', 'uncanny-automator-pro' ),
						true,
						'textarea',
						__(
							'Hi {{user_firstname}},
					...
					The {{site_name}} team',
						...
						true,
						sprintf( __( 'Use following tokens in email: %s', 'uncanny-automator-pro' ), join( '<br />', $available_codes ) )
					),
				),
			),
		);
